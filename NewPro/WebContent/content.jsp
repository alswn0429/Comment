...
<body>
  <form action="/new/replyForm.bbs?articleNumber=${article.articleNumber}&pageNum=${pageNum}" method="post">
        ...
        <div>
          ...
          <thead>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <a href="/new/download.bbs?fileName=${article.fileName}">${article.fileName}</a>
              </td>
            </tr>
          </thead>
          <tbody>
          ...
          <c:if test="${id != null}">
            ...
            <c:if test="${id == article.id}">
              <input type="button" class="btn btn-default" value="수정하기" onclick="document.location.href='/new/updateForm.bbs?articleNumber=${article.articleNumber}&pageNum=${pageNum}'">
              <input type="button" class="btn btn-default" value="삭제하기" onclick="document.location.href='/new/delete.bbs?articleNumber=${article.articleNumber}&pageNum=${pageNum}'">
            </c:if>
            <c:if test="${id != article.id}">
          ...
          <input type="button" class="btn btn-default" value="목록으로" onclick="document.location.href='/new/list.bbs?pageNum=${pageNum}'">
        </div>
